...
import com.example.payroll.order.OrderRespository;
...
public class LoadDatabase {
    ...
    @Bean
    CommandLineRunner initDatabase(EmployeeRepository employeeRepository, OrderRespository orderRepository) {
        return args -> {
