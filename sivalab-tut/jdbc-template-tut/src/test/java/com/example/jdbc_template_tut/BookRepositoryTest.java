...
import com.example.jdbc_template_tut.bookmark.Bookmark;
import com.example.jdbc_template_tut.bookmark.BookmarkRepository;
...
public class BookRepositoryTest {
    ...
    void shouldCreateBookmark() {
        ...
        Long id = bookmarkRepository.create(bookmark);
    ...
    void shouldUpdateBookmark() {
        ...
        Bookmark updatedBookmark = new Bookmark(id, "My Update Title", "https://sivalabs.in", bookmark.createdAt());
